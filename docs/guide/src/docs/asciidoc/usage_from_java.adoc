...
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=risRecords]
----
...
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=fromList]
----
...
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=fromListCustomSort]
----
...
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=fromObservable]
----
...
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=writerExport]
----

.Writing the list of `RisRecords` in a blocking manner into a file [Java]
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=fileExport]
----

.Writing the list of `RisRecords` in a blocking manner into an output stream [Java]
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=streamExport]
----

.Writing the list of `RisRecords` in a blocking manner into a path [Java]
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=pathExport]
----
...
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=processReader]
----

.Reading RIS records from File [Java]
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=processFile]
----

.Reading RIS records from InputStream [Java]
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=processInputStream]
----

.Reading RIS records from Path [Java]
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=processPath]
----
...
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=passRisLinesAsList]
----
...
[subs=attributes+,source,java]
----
include::../../../../../subprojects/jris/src/test/java/com/gmail/gcolaianni5/jris/example/guide/GuideExamples.java[tags=processObservables]
----
